...
if ($foo == 3 or $foo == 11){
    echo $element_button . "<span style='font-size:20px'>". $element_symbol[$foo] ."</span><br><span style='font-size:10px'>". $element_name[$foo] ."<br>".$element_number[$foo]."</span>". $button_close.$br;
