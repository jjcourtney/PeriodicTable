...
<script type="text/javascript" src="periodic.js"></script>
 ...
 $looped_once = false;
 $button_close = '</button>';
$blank_button = '<button class="button_blank">XX</button>';
...
while ($foo<118){
$foo = $foo +1;
$element_button ='<button class="'.$element_type[$foo]. '" id="'. $element_name[$foo].'" onmouseover="change_div('.$quote.$foo.$quote.')">';
...
*/
?>
<div id="main_div" class="main_div">Welcome to my interactive periodic table</div>
